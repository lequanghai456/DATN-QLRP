...
app.factory("datasevice", function ($http) {
    ...
    return {
        ...
        BookTickets: function (data, callback) {
            ...
            $http.post('http://haile123-001-site1.ctempurl.com/Staffs/home/BuyTicket',data).then(callback);
        },
        PurcharseTicket: function (data, callback) {
            $http.get('http://haile123-001-site1.ctempurl.com/Staffs/home/Purchase/' + data + '?IsT=true').then(callback);
        },
        PurcharseBill: function (data, callback) {
            $http.get('http://haile123-001-site1.ctempurl.com/Staffs/home/Purchase/' + data + '?IsT=false').then(callback);
        },
